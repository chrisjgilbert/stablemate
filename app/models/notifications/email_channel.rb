module Notifications
  ...
  class EmailChannel < Channel
    def deliver
      ...
      # granularity for the transition-only audit log in V1. Dispatch defers this
      # whole method until the caller's transaction commits, so the enqueue and
      # the stamp stand or fall together — the row can never claim an alert that
      # was never queued.
