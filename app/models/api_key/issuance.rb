class ApiKey
  # Operation (architecture.md §4): generate a fresh API key for a project, persist
  ...
  #
  # Reached via ApiKey.issue(project:, name:) -> [api_key, raw_token].
  class Issuance
    ...
    def issue
      ...
      api_key = @project.api_keys.create!(
        name: @name,
