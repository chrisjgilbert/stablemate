module Monitors
  ...
  # updating the monitor's (singular) ping_token.
  class PingTokensController < ApplicationController
    ...
    def update
      ...
      # setup as the full top card. An anchored redirect doesn't work here,
      # because Turbo follows form redirects via fetch, which drops the URL
      # fragment before the browser ever sees it.
