module Billing
  # Shared base for the authenticated billing UI controllers. When billing is
  # disabled — the self-host default — the whole namespace 404s, so a keyless
  # instance has no billing surface and the UI never links here.
  #
  ...
  class BaseController < ApplicationController
    ...
    private
      ...
      # picker they can no longer satisfy. Deletions lift it as they happen; this is
      # the backstop for getting back within cap WITHOUT a deletion — chiefly a
      # voluntary downgrade racing its own cancel webhook.
